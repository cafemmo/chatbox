...
var Chat = function(_0x530c12, _0x1af842, _0x157c41) {
	...
	//_0xf9ea['39'] = '<div\x20data-id=\x27%s\x27\x20data-ip=\x27%s\x27\x20class=\x27shoutText\x27>%s<span\x20class=\x27shoutDate\x27>%s\x20</span><span\x20class=\x27shoutUserText\x27>%s</span>:\x20%s<button\x20class=\x27shoutboxBanBtn\x27>ban</button><button\x20class=\x27shoutboxDelBtn\x27>del</button></div>';
	//_0xf9ea['32'] = '<div\x20class=\x27shoutServerText\x27\x20id=\x27%s\x27>Wellcome '+_0x157c41+'</div>';
    if (localStorage['getItem']('email')) {
        $('#shoutboxEmailAdmin')['val'](localStorage['getItem']('email'));
    }
    if (localStorage['getItem']('password')) {
        $('#shoutboxPasswordAdmin')['val'](localStorage['getItem']('password'));
    }
    var _0x1471b5 = 'https://www.shoutbox.com';
    this['AJAX'] = 'https://www.shoutbox.com/chat/ajax.php';
    var _0x2d9d59 = this;
    _0x1af842 = _0x1af842 || '';
    ...
    $['post'](_0x2d9d59['AJAX'], {
        ...
        _0x47cc56 = JSON['parse'](_0x47cc56);
        if (!_0x47cc56['paid']) {
            if (parseInt(_0x47cc56['entries']) > 0x64) {
                _0x2d9d59['showAd']();
            }
    ...
    String['prototype']['replaceAll'] = function(_0x5b8826, _0x1658f2) {
        return this['split'](_0x5b8826)['join'](_0x1658f2);
    };
    this['ago'] = function(_0x1e778d) {
        var _0x3e53c6 = Math['floor']((new Date() - _0x1e778d) / 0x3e8);
        var _0xb96d96 = Math['floor'](_0x3e53c6 / 0x1e13380);
        if (_0xb96d96 > 0x0) {
            return _0xb96d96 + _0xaf9e('0x19');
        }
        _0xb96d96 = Math['floor'](_0x3e53c6 / 0x278d00);
        if (_0xb96d96 > 0x0) {
    ...
    this['parseSmileys'] = function(_0x43f696) {
        for (var _0x3c95ed in this['smileys']) {
            var _0x519866 = this['smileys'][_0x3c95ed];
            _0x43f696 = _0x43f696['replaceAll'](_0x3c95ed, _0x519866);
        }
        return _0x43f696;
    };
    this['stripHTML'] = function(_0x30c3c7) {
        var _0x42a2fb = document['createElement']('div');
        _0x42a2fb['innerHTML'] = _0x30c3c7;
    ...
    this['refreshChat'] = function() {
        ...
        $['post'](_0x10ff69['AJAX'], {
            ...
            for (var _0x3bded4 = _0x561900['length'] - 0x1; _0x3bded4 >= 0x0; _0x3bded4--) {
				...
				// }
				var theAdd = new Date(1900,0,1,_0x26faf8['date'].split(":")[0],_0x26faf8['date'].split(":")[1]);
				 theAdd.setHours(theAdd.getHours() + 5);
				var hourInsert = theAdd.getHours();
				 if(hourInsert < 10){
					 hourInsert = "0" + hourInsert  
				 }
				 
				 var minuteInsert = theAdd.getMinutes();
				 if(minuteInsert < 10){
					 minuteInsert = "0" + minuteInsert  
				 }
				 
				 var timeInsert = hourInsert+":"+minuteInsert;
				
				
				
				
                _0x10ff69['receiveText'](_0x26faf8['username'], _0x26faf8['message'], timeInsert, 0x0, _0x26faf8['avatar'], _0x26faf8['ip'], _0x26faf8['id']);
            }
        });
    };
        ...
        $['post'](_0x3782bd['AJAX'], {
            ...
            for (var _0x4241d1 = _0x175b53['length'] - 0x1; _0x4241d1 >= 0x0; _0x4241d1--) {
				...
				// if(_0x407f9d['username'] == _0x1af842){
					// _0x407f9d['username'] = _0x157c41;	
				// }
				 var theAdd = new Date(1900,0,1,_0x407f9d['date'].split(":")[0],_0x407f9d['date'].split(":")[1]);
				 theAdd.setHours(theAdd.getHours() + 5);
                ...
                _0x3782bd['receiveText'](_0x407f9d['username'], _0x407f9d['message'], timeInsert, 0x0, _0x407f9d['avatar'], _0x407f9d['ip'], _0x407f9d['id']);
            }
            if (_0x3782bd['myUser']['username'] !== '') {
                _0x3782bd['welcome']();
            }
        });
    };
    ...
    this['serverMessage'] = function(_0x186e36) {
        var _0x2c2efa = $('#shoutChat');
        _0x2c2efa['append'](sprintf(_0x2d9d59['traductions']['serverMessage'], _0x186e36));
        _0x2c2efa['animate']({
            'scrollTop': _0x2c2efa[0x0]['scrollHeight']
        }, 0x3e8);
    };
    this[_0xaf9e('0x3c')] = function(_0x18da0f, _0x101e63, _0x24dcf6, _0x1c2fc8, _0x38afa9, _0x3d1db8, _0x479079) {
        _0x18da0f = this['stripHTML'](_0x18da0f);
        ...
        var _0xf002d9 = sprintf(_0x2d9d59['traductions'][_0xaf9e('0x53')], _0x479079, _0x3d1db8, _0x38afa9, _0x24dcf6, _0x18da0f, _0x101e63);
    ...
    this['addUser'] = function(_0x4fd905) {
        if (_0x4fd905['username'] === '') {
            _0x4fd905['username'] = 'Guest';
        }
        this['updateNumberUsersDisplay']();
        var _0x157c41 = _0x4fd905['avatar'];
        if (_0x157c41 !== '') {
            var _0x38fb3d = _0x4fd905['avatar'] || 'avatars/' + Math['ceil'](Math['random']() * 29) + '.svg';
            _0x157c41 = sprintf(_0x2d9d59['traductions']['imageAvatar'], _0x38fb3d);
        }
        var _0x577e7d = sprintf(_0x2d9d59['traductions']['addUser'], _0x4fd905['id'], _0x4fd905['id'], _0x157c41, _0x4fd905['username']);
        $('#shoutBoxUserList')['append'](_0x577e7d);
    };
    document['getElementById']('shoutBoxInput')['addEventListener']('keypress', _0x9e3165['bind'](this), ![]);
    this['getLastMessages']();
    this['users'] = [];
    this['shoutboxSocket'] = io['connect'](_0x1471b5 + ':1400');
    this['shoutboxSocket']['on']('connect', function() {
        var _0x1af842 = _0x2d9d59['stripHTML'](localStorage['getItem']('username'));
        if (_0x1af842) {
            _0x2d9d59['myUser']['username'] = _0x1af842;
        }
	//_0x2d9d59['myUser']['username'] = 'Tuấn';
		
		
        _0x2d9d59['shoutboxSocket']['emit']('enterRoom', _0x2d9d59['myUser']);
    });
    ...
    this['shoutboxSocket']['on']('del', function(_0x5c9115) {
        var _0x4c6cb4 = sprintf('*[data-id=%s]', _0x5c9115);
        $(_0x4c6cb4)[_0xaf9e('0x65')]();
    });
    this['shoutboxSocket']['on'](_0xaf9e('0x66'), function(_0x40a648) {
    ...
    $(_0xaf9e('0x6a'))['on'](_0xaf9e('0x6b'), '.shoutboxDelBtn', function() {
        ...
        _0x2d9d59['shoutboxSocket']['emit'](_0xaf9e('0x70'), _0xb3a2c7);
    });
    this['shoutboxSocket']['on']('userChanged', function(_0x48682d) {
        var _0x157c41 = _0x48682d['avatar'];
        if (_0x157c41 !== '') {
            _0x157c41 = sprintf(_0x2d9d59['traductions'][_0xaf9e('0x5b')], _0x157c41);
        }
        var _0x3e25af = sprintf(_0x2d9d59['traductions']['addUser'], _0x48682d['id'], _0x48682d['id'], _0x157c41, _0x48682d['username']);
        $(_0xaf9e('0x71') + _0x48682d['id'])['html'](_0x3e25af);
    });
    this['shoutboxSocket']['on'](_0xaf9e('0x68'), function(_0x558295) {
        _0x2d9d59['setAdminMode'](_0x558295);
        $(_0xaf9e('0x72'))[_0xaf9e('0x73')](_0xaf9e('0x74'));
    });
    this['shoutboxSocket']['on'](_0xaf9e('0x75'), function(_0x41a536) {
        console[_0xaf9e('0x76')](_0x41a536);
    });
    this['shoutboxSocket']['on'](_0xaf9e('0x57'), function(_0xa7eeda) {
    ...
    $(document)['on'](_0xaf9e('0x6b'), _0xaf9e('0x77'), function() {
        ...
        _0x2d9d59[_0xaf9e('0xb')]['username'] = '';
    ...
    this['updateNumberUsersDisplay'] = function() {
        ...
        var _0x26aa34 = sprintf(_0x2d9d59['traductions'][_0xaf9e('0x7c')], _0x2c67ab);
        if (_0x2d9d59['users'][_0xaf9e('0x3b')] > 0x1) {
            _0x26aa34 = sprintf(_0x2d9d59['traductions'][_0xaf9e('0x7d')], _0x2c67ab);
        }
        $('#shoutBoxHeaderText')['text'](_0x26aa34);
    };
    this['shoutboxSocket']['on'](_0xaf9e('0x7e'), function(_0x534bfc) {
        _0x2d9d59['users'] = _0x534bfc;
    ...
    $(_0xaf9e('0x94'))[_0xaf9e('0x6b')](function() {
        ...
        $[_0xaf9e('0x8f')]({
            ...
            'success': function(_0x4227ba) {
                ...
                _0x2d9d59['shoutboxSocket']['emit'](_0xaf9e('0x9b'), _0x5b24fc);
            }
        });
    });
